...
- correlation grouping/exclusion and nested effective subsets: PR #35 (`dc26b35`);
...
| PR #35 / `dc26b35` | Predeclared threshold, groups, holdout-linked exclusions, 20/38/78 effective subsets | draft; dependent on #34 final manifest |
...
| PR #40 | Eight validator hardening regressions | ready; external review pending |
...
- split self-test 16/16, linkage self-test 5/5 and schema validation in #35;
- C0 report regeneration and GPU evidence in merged #36;
- Day 8 rerun of #37: pipeline self-test 5/5, probe search 8/8, variant paths 10/10, both checkpoint reloads
