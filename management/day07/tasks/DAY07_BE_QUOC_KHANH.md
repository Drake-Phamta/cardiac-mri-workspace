...
| **6** | **Góp ý chuyên môn cho `DR-002b`** — bản thảo đã sẵn sàng: [`OPEN_DECISIONS.md`](../../readiness/OPEN_DECISIONS.md) Part 2b, bốn phương án, Project Control đề xuất **(c) + (d)**. Ý kiến của bạn với tư cách chủ Spike D: **ngưỡng tương quan nên đặt ở đâu** theo phân bố 11 781 cặp bạn đã có (phải bắt được cặp r ≈ 0,996 và phải khai **trước** mọi lượt train), **bao nhiêu cặp/ca bị ảnh hưởng** ở ngưỡng đó, và nếu (c) được chọn thì **mất bao nhiêu case train** vì loại case nghi trùng với holdout | ~1 h | không | comment có nội dung; leader quyết trong ngày |
