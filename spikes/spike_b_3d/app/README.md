...
and diffuse shading, and supports orbit rotation plus wheel/pinch zoom. No
...
Drag on the canvas to orbit, use the wheel or a two-finger pinch to zoom, and
use **fit camera** to restore the demo view. The displayed mesh is synthetic
